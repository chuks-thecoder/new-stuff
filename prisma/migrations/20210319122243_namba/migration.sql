/*
  ...
  - You are about to drop the column `profileId` on the `comments` table. All the data in the column will be lost.
  - You are about to drop the column `profileId` on the `likes` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `comments` DROP COLUMN `profileId`;

-- AlterTable
ALTER TABLE `likes` DROP COLUMN `profileId`;
